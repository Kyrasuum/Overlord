...
{
   idd = 7770;
   onLoad = "uiNamespace setVariable ['RscDisplayServerInfoMenu', _this select 0]; [] ExecVM 'plugins\ServerInfoMenu\sqf\onLoad.sqf'; playSound ['ZoomIn', true]; 'DynamicBlur' ppEffectEnable true; 'DynamicBlur' ppEffectAdjust [7]; 'DynamicBlur' ppEffectCommit 0.1";
   ...
   class Controls
   {
      ...
      class menuTitle:RscText
      {
         ...
         colorBackground[] = {0.7607,0.1176,0.3373,0.8};
         colorText[] = {1,1,1,0.95};
         font = "PuristaLight";
         idc = -1;
         shadow = 0;
      ...
      class menu:RscListbox
      {
         ...
         idc = 7;
         onLBSelChanged = "[] ExecVM 'plugins\ServerInfoMenu\sqf\handleContent.sqf'";
      };
